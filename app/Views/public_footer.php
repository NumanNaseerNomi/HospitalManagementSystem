          ...
          <div class="container">
               <div class="row">
				...
				<div class="opening-hours">
                                   ...
                                   <pre><span><?php echo $compWorkingHrs; ?> </span></pre>
                    ...
                    <div class="col-md-12 col-sm-12 border-top">
                         <div class="col-md-4 col-sm-6">
                              <div class="copyright-text"> 
                                   <span>Copyright &copy; 2022 <?php echo $compPublicName; ?> </span>
                              </div>
                         </div>
                         ...
                         <div class="col-md-2 col-sm-2 text-align-center">
                              <div class="angle-up-btn"> 
                                  <a href="#top" class="smoothScroll wow fadeInUp" data-wow-delay="1.2s"><i class="fa fa-angle-up" style="background-color: #fff;"></i></a>
                              </div>
                         </div>   
                    </div>
...
//vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv by fares
